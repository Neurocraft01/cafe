...
import { Check, Clock, Wifi, Armchair, Leaf, Palette, MapPin, Phone } from 'lucide-react';
import Image from 'next/image';

const workspaceImages = [
  { src: "/coworking1.jpg", alt: "Comfortable ergonomic coworking seating at Café VanaBella Pune" },
  { src: "/coworking2.jpg", alt: "High-speed WiFi coworking desks at Café VanaBella Pune" },
  { src: "/coworking3.jpg", alt: "Peaceful nature-inspired coworking atmosphere at Café VanaBella Pune" }
];
    ...
    <div className='min-h-screen bg-white text-black selection:bg-black selection:text-white'>
      ...
      <section className='relative h-[60vh] flex items-center justify-center overflow-hidden bg-emerald-950'>
        <div className='absolute inset-0 z-0'>
          <Image 
            src='/IMG_7964.JPG'
            alt='Coworking space at Café VanaBella in Pimple Nilakh Pune'
            fill
            className='object-cover opacity-60'
            priority
          />
        </div>
        <div className='relative z-10 text-center px-4 py-16 md:py-24 text-white max-w-4xl mx-auto'>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className='text-4xl md:text-6xl font-serif font-bold mb-4 font-cinzel leading-tight'
          >
            Coworking Space in <br className="hidden sm:inline"/> Pimple Nilakh, Pune
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.2 }}
            className='text-xl md:text-2xl font-light italic mb-6 text-emerald-200'
          >
            Work. Sip. Connect.
          </motion.p>
           <motion.p 
          ...
          >
            Experience a tranquil coworking space with high-speed fiber internet, great coffee, and a calm green environment.
          </motion.p>
        </div>
      </section>
            ...
            <div className='flex flex-col md:flex-row items-center gap-12'>
                <div className='md:w-1/2'>
                    ...
                    <p className='text-gray-700 text-lg leading-relaxed mb-6'>
                        Bored of the same four walls? Swap your cubicle for our cafe. We offer high-speed WiFi, dedicated power sockets, and the calming background sound of running water and greenery. 
                    </p>
                ...
                <div className='md:w-1/2 relative h-[400px] w-full rounded-2xl overflow-hidden shadow-xl'>
                     <Image 
                        src='/coworking3.jpg'
                        alt='Work from nature desk and cafe setup at Café VanaBella Pune'
                        fill
      ...
      <section className='py-20 px-4 bg-white'>
        <div className='container mx-auto max-w-6xl'>
          <div className='text-center mb-16'>
            <h2 className='text-3xl font-serif font-bold mb-4'>Our <span className='italic text-emerald-600'>Workspace</span></h2>
            <p className='text-gray-600 max-w-2xl mx-auto'>A glimpse into your productive and inspiring coworking environment</p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            {workspaceImages.map((img, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className='relative h-64 overflow-hidden group rounded-2xl shadow-lg hover:shadow-2xl transition-all'
              >
                <Image 
                  src={img.src}
                  alt={img.alt}
                    ...
                    <div>
                         ...
                         <div className='space-y-4'>
                            <div className='flex items-start gap-3 text-gray-600'>
                                ...
                                <p className='text-sm md:text-base'>3, GK Ln., near Srimal Hospital, Nandanwan Society, Vishal Nagar, Pimple Nilakh, Pimpri-Chinchwad, Maharashtra 411027</p>
                            </div>
                             <div className='flex items-start gap-3 text-gray-600'>
                                <Phone className='flex-shrink-0 mt-1 text-emerald-600' size={20} />
                                <p className='text-sm md:text-base'>82620 22502 / 79724 93209</p>
                            </div>
                         </div>
                    </div>
                </div>
