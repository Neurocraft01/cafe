    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-black">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden bg-emerald-950">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/DSC_3867.JPG"
            alt="Reserve a table at Café VanaBella Pure Veg Café in Pimple Nilakh Pune"
            fill
        ...
        <div className="relative z-10 text-center px-4 text-white">
          ...
          >
            Reserve a Table at <span className="italic font-light font-serif text-emerald-200">Café VanaBella</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="text-emerald-100 font-light text-base md:text-lg max-w-2xl mx-auto"
          >
            Book your table for an unforgettable pure veg dining experience in Pimple Nilakh, Pune
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 group hover:bg-gray-50 p-3 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a href="tel:+918262022502" className="text-lg font-semibold text-gray-800 hover:text-green-600 transition-colors">
                        +91 82620 22502
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 group hover:bg-gray-50 p-3 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a href="tel:+917972493209" className="text-lg font-semibold text-gray-800 hover:text-blue-600 transition-colors">
                        +91 79724 93209
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 group hover:bg-gray-50 p-3 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-800">11:00 AM - 11:00 PM</p>
              ...
              >
                ...
                <div className="text-sm text-gray-600">120+ Verified Reviews</div>
