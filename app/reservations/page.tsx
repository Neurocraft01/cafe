                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 group hover:bg-gray-50 p-3 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a href="tel:+918972493209" className="text-lg font-semibold text-gray-800 hover:text-green-600 transition-colors">
                        +91 8972493209
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 group hover:bg-gray-50 p-3 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a href="tel:+919074627887" className="text-lg font-semibold text-gray-800 hover:text-blue-600 transition-colors">
                        +91 90746 27887
                      </a>
                    </div>
                  </div>
