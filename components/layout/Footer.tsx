      ...
      <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4 text-sm text-gray-600">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span> 82620 22502 / 79724 93209</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={18} className="text-black" />
                <span>cafevanabella@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 uppercase tracking-wider gap-y-4">
          ...
          <div className="flex space-x-6">
            <Link href="/seo-verification" className="hover:text-emerald-700 font-semibold text-emerald-800 transition-colors">SEO Status</Link>
