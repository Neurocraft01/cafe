...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="container mx-auto pl-0 pr-2 md:pr-6 flex justify-between items-center">
        
        {/* Logo */}
        <Link href="/" className="relative z-[60] group">
          <div className="flex items-center h-14 md:h-16 overflow-hidden bg-gradient-to-br from-emerald-40 to-white rounded-lg pl-2 pr-2">
            <Image 
              src="/logo.jpg" 
              alt="Café VanaBella logo - pure veg café Pimple Nilakh Pune" 
              width={220} 
              height={60} 
              className="object-contain object-left w-auto h-full mix-blend-multiply"
