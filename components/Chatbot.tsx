  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Reservations
        ...
        botResponse = "Select 'Reserve Table' button to reserve your table.";
      } 
      // Hours
        ...
        botResponse = "We're open daily from 11:00 AM to 11:00 PM, all 7 days of the week! Perfect for lunch, dinner, coffee, or coworking in our plant-filled garden setting with 200+ plants. ⭐ Rated 4.8/5 with 120+ verified reviews!";
      } 
      // Location
        ...
        botResponse = "📍 We're located in Pimple Nilakh, Pune (Near Srimal Hospital), Maharashtra, India. We have 200+ plants, garden seating, pet-friendly space, and WiFi! Rated ⭐ 4.8/5 by 120+ guests. Visit our Contact page for map. Follow @cafevanabella on Instagram!";
      } 
      // Workshops
      else if (userMessage.includes("workshop") || userMessage.includes("class") || userMessage.includes("cooking") || userMessage.includes("learn")) {
        botResponse = "We offer exciting workshops! 🎨 Art Workshop (Canvas painting, Clay art, Pottery), 🎲 Game Workshop (Board games, Housie, Fun learning), and 🧴 Making Workshop (Perfume making, Chocolate making). Check our Workshop page for details!";
      } 
      // Coworking
        ...
        botResponse = "Experience our unique co-working space surrounded by nature! 🌿 Hours: 10:30 AM - 8:00 PM. We offer Day Passes (₹399), 1-Week Passes (₹2,699), and 1-Month Passes (₹7,999). Includes High-speed Wi-Fi, Comfortable seating, and Coffee/Tea/Food coupons. Contact +91 82620 22502 for bookings!";
      } 
      // Celebrations/Events
      ...
      // Contact
        ...
        botResponse = "Reach us at: Instagram @cafevanabella | Email: cafevanabella@gmail.com. Visit our Contact page for more details. We respond within 1-2 hours!";
      }
      // Special requests
      ...
      // About
        ...
        botResponse = "VanaBella opened in 2024 as an urban sanctuary blending nature with flavor. Located in Pimple Nilakh, Pune with 200+ plants, we offer 100+ vegetarian dishes, coworking space, culinary workshops, and event hosting. Pet-friendly & WiFi enabled! ⭐ 4.8/5 rating with 120+ reviews. Visit our About page!";
      }
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
              ...
              {showOptions && messages.length === 1 && (
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {["Menu", "Birthday Celebration", "Location", "Reserve Table"].map((option) => (
                    <button
                      key={option}
