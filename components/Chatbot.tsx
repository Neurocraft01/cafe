  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Coworking
        ...
        botResponse = "Experience our unique co-working space surrounded by nature! 🌿 Hours: 10:30 AM - 8:00 PM. We offer Day Passes (₹399), 1-Week Passes (₹2,600), and 1-Month Passes (₹7,999). Includes High-speed Wi-Fi, Comfortable seating, and Coffee/Tea/Food coupons. Contact 90746 27887 for bookings!";
      } 
      // Celebrations/Events
